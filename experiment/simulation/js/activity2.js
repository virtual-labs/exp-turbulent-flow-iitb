...
function a6_mouseclick_timer_stop(e) {
    ...
    if (y >= 240 && y <= 290) {
        if (x >= 1080 && x <= 1160) {
            ...
            let tab_ele = document.getElementById('obs-tab');
...
function verify_table() {
    let res1 = document.getElementById('a2-inp1');
    let res2 = document.getElementById('a2-inp2');
    let res3 = document.getElementById('a2-inp3');
    let res4 = document.getElementById('a2-inp4');
    let res5 = document.getElementById('a2-inp5');
