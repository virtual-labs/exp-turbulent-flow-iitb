namespace Chemistry {
   ...
   export class Dual_Anim extends anim_image {

    custome_img: Chemistry.Custome_image;
    timer: number = 0;
    shift: number;
    delay: number;
    ...
    constructor(image:CanvasImageSource, custome_img: Chemistry.Custome_image, stpt:Point,width:number,height:number, shift: number, delay: number, canvas:HTMLCanvasElement) {
        super(image, stpt, width, height, canvas);
